...
struct QuestionsViewCaptain77734: View {
    @State var selectedQuestion: Tab4QuestionCaptain77734 = Tab4QuestionCaptain77734.list.randomElement()!
            ...
            if isInternetAvailable() {
                ...
                HStack {
                    ...
                    Button {
                        ...
                        selectedQuestion = Tab4QuestionCaptain77734.list.randomElement()!
                    } label: {
                        Image("tab4.generate")
                    }
...
#Preview {
    ContentViewCaptain77734(showLoading: false, selectedTab: .questions)
}

struct Tab4QuestionCaptain77734 {
    let question: String
    let hint1: String
    let hint2: String
    let answer: String
    
    static let list: [Tab4QuestionCaptain77734] = [
        Tab4QuestionCaptain77734(
